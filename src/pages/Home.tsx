...
export default function Home() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background text-foreground relative">
      ...
      <div className={`
        fixed inset-y-0 right-0 z-40 flex w-full flex-col border-l bg-background/95 backdrop-blur-sm transition-transform duration-300 ease-in-out md:static md:w-[400px] lg:w-[480px] md:translate-x-0
